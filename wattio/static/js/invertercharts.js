    ...
    function createColumnChartOptions() {
        return {
            ...
            xaxis: { 
                ...
                labels: { 
                    show: false,
                    format: 'dd MMM', // Display format for the x-axis labels
                    style: { colors: '#555', fontFamily: 'Arial', fontSize: '10px' }
                } 
            },
        ...
        try {
            ...
            if (dataresponse.length > 0) {
                const seriesData = [{
                    ...
                    color: chartColors[0] // Use the first color for this single series
                }];
